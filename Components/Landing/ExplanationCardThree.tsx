...
function ExplanationCardThree() {
  return (
    <div className="relative max-w-[400px] rounded-[13px] border-2 border-[#ffffff10] pb-[26px] [background:radial-gradient(208.21%_100.36%_at_68.71%_2.35%,_rgba(255,255,255,0.01)_30.51%,rgba(255,255,255,0.03)_100%)]">
      {/* Notification Cards */}
      <div className="relative z-[2] flex h-full max-h-[280px] w-full items-center justify-center">
        {/* Main Card */}
        <div className="relative mx-[3%] w-full max-w-[330px] ">
          ...
          <div className="absolute left-[-17%] bottom-[-120%] z-10 flex size-[70px] rotate-[-24deg] scale-[76%] items-center justify-center rounded-[18px] bg-gradient-to-br from-[#2c304678] to-[#40456462] backdrop-blur-[10px]">
            <Image
          ...
          <div className="absolute bottom-[-70%] right-[-16%] z-10 flex size-[50px] rotate-[11deg] scale-[100%] items-center justify-center rounded-[12px] bg-gradient-to-br from-[#2c304678] to-[#40456462] backdrop-blur-[10px]">
            <Image
      ...
      {/* Shining Background */}
      <div className="absolute top-0 h-full w-full overflow-hidden rounded-[11px]">
        <div className="absolute left-1/2 top-0 h-full w-[200%] translate-x-[-50%] opacity-20">
          ...
          <div className="from-2% absolute inset-0 z-[1] bg-gradient-to-b from-[#ffffff55] to-[#ffffff10] to-75% [clip-path:polygon(0_0,100%_0,50%_100%)]"></div>
        </div>
      </div>
      ...
      <div className="px-[26px] text-center">
        ...
        <p className="object-top text-[16px] font-normal leading-[135%] text-[#ffffff91]">
          Use others referral links to collect benefits when signing up on .
          This usually comes with benefits for both of you.
        </p>
      </div>
    </div>
  );
...
export default ExplanationCardThree;

...
function Modal({
  ...
  return (
    <div
      ...
      ref={ref}
      className={cn(
        "transition-all group fixed inset-0 z-[10000] flex cursor-auto items-center justify-center bg-[#09071cc6] duration-150 backdrop-blur-[4px] sm:items-start overflow-y-auto",

  ...
  return (
    ...
    >
      <div className="flex size-full flex-col items-center justify-center">
        <Image
          className="object-contain h-full max-h-[55px] w-auto max-w-[85px] rounded-md transition-transform duration-200 group-hover:scale-[105%] lg:max-h-[50px] sm:max-w-[65px]"
